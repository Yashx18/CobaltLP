const CTA = () => {
  return (
    <div className="group relative mx-auto w-fit">
      ...
      <button className="transitioncolor relative cursor-pointer rounded-full bg-black px-4 py-2 text-sm text-neutral-300 ring ring-white/8 transition-all  duration-400 group-hover:text-neutral-200 group-hover:shadow-[0_0_20px_2px_#2b7fff]/20 group-active:shadow-[0_0_20px_2px_#b8e6fe]/20">
        Join the waitlist
      </button>
