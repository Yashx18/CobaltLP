    ...
    <section className="relative h-fit w-full bg-[#09090b] px-6 sm:px-10">
      ...
      <div className="mx-auto w-full max-w-5xl pt-40">
        <div className="mx-auto my-0 flex h-full max-w-4xl flex-col items-center justify-center">
          ...
          <p className="mt-6 max-w-2xl text-center text-md sm:text-lg text-neutral-400">
        ...
        <div className="flex w-full grid-cols-2 flex-col items-start gap-2 pb-10 sm:py-10 md:py-20 lg:grid lg:gap-5">
          <div className="col-span-1 lg:pr-10">
            <h2 className="tracking-light bg-[linear-gradient(to_bottom_right,white,grey)] bg-clip-text pb-2 text-2xl sm:text-3xl md:text-4xl font-bold text-transparent">
              Who said finance has to be boring?
            </h2>
          </div>
          <div className="col-span-1 w-full text-md sm:text-lg md:text-xl text-neutral-400">
            <p>
